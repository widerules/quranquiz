#!/bin/bash
#
# Written for Quran Quiz Net
# Copyright 2013 Tarek Eldeeb <tarekeldeeb@gmail.com>
# Check LICENSE
#
...
sed 's/['"$HARAKAT"'|''0-9'"$SMALLALEF"']//g' < quran-uthmani-min.sym.txt > quran-uthmani-min.t2.txt
