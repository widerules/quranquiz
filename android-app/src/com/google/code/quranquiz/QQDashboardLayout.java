 ...
 */
public class QQDashboardLayout extends ViewGroup {
	...
	public QQDashboardLayout(Context context) {
		super(context, null);
	}

	public QQDashboardLayout(Context context, AttributeSet attrs) {
		super(context, attrs, 0);
	}

	public QQDashboardLayout(Context context, AttributeSet attrs, int defStyle) {
